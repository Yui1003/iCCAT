...
export default function Navigation() {
  ...
  // Generate turn-by-turn steps for indoor navigation using pixel-space bearings
  const generateIndoorSteps = (
    ...
    // Build coordinate → IndoorNode lookup (lat = x, lng = y in pixel space)
    ...
    // Final "continue to destination" step for remaining distance
